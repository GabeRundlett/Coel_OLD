...
int main() {
    ...
    Coel::create(texture, "Assets/Textures/ground.png");

    Coel::setMagFilter(texture, Coel::Linear);
    Coel::setMinFilter(texture, Coel::Linear);
    Coel::setWrapMode(texture, Coel::Repeat);
